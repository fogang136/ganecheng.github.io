...
$upx->uploadx_type = 'jpg|gif|apk|rar|zip|png|swf';    //允许上传类型(根据后缀限制上传类型,每个后缀用“|”隔开)  
...
class uploadx {
       ...
       function __construct(){//初始化函数
          ...
          $this->uploadx_type = 'jpg|gif|png|swf|apk|rar|zip|flv|rar|7z|zip|doc|docx|ppt|pptx|xls|xlsx|txt|pdf|wav|mp3|wma|rm|rmvb|wmv';         
